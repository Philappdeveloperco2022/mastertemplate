    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'Pincode':
          ...
          break;
        case 'PinCodeConfirm':
          result.pinCodeConfirm = serializers.deserialize(value,
              specifiedType: const FullType(int)) as int?;
          break;
        case 'SponsorID':
          ...
          break;
        case 'MyCompanyID':
          result.myCompanyID = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String?;
          break;
...
class _$UserRecord extends UserRecord {
  ...
  bool operator ==(Object other) {
    ...
    return other is UserRecord &&
        ...
        pinCodeConfirm == other.pinCodeConfirm &&
            ...
            $jc(
                $jc(
                    $jc(
                        ...
                        pincode.hashCode),
                    pinCodeConfirm.hashCode),
                sponsorID.hashCode),
            myCompanyID.hashCode),
        ffRef.hashCode));
  }
  ...
  String toString() {
    return (newBuiltValueToStringHelper(r'UserRecord')
          ...
          ..add('pincode', pincode)
          ..add('pinCodeConfirm', pinCodeConfirm)
          ..add('sponsorID', sponsorID)
          ..add('myCompanyID', myCompanyID)
          ..add('ffRef', ffRef))
        .toString();
  }
}
...
class UserRecordBuilder implements Builder<UserRecord, UserRecordBuilder> {
  ...
  int? _pinCodeConfirm;
  int? get pinCodeConfirm => _$this._pinCodeConfirm;
  set pinCodeConfirm(int? pinCodeConfirm) =>
      _$this._pinCodeConfirm = pinCodeConfirm;
  ...
  String? _myCompanyID;
  String? get myCompanyID => _$this._myCompanyID;
  set myCompanyID(String? myCompanyID) => _$this._myCompanyID = myCompanyID;
  ...
  UserRecordBuilder get _$this {
    ...
    if ($v != null) {
      ...
      _pincode = $v.pincode;
      _pinCodeConfirm = $v.pinCodeConfirm;
      _sponsorID = $v.sponsorID;
      _myCompanyID = $v.myCompanyID;
      _ffRef = $v.ffRef;
      _$v = null;
    }
    return this;
